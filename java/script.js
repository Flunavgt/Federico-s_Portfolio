...
const arr1 = [
  ...
  {
    id: 1,
    popuptitle: 'Budget app',
    popupdescription: 'App created to manage expenses and file them into different categories',
    popuptec: ['CSS', 'HTML', 'Bootstrap', 'Ruby'],
    popupimg: './pictures/budget-app.png',
    btnlive: 'https://budget-app-production-2d81.up.railway.app',
    btnsource: 'https://github.com/Flunavgt/budget-app',
    btnName: 'btn3',
    btnimg1: './pictures/TimeAndIcons/github.png',
    btnimg2: './pictures/TimeAndIcons/github.png',
  },
  {
    id: 2,
    popuptitle: 'Oceans and Trails',
    popupdescription: 'This is the third A daily for this is a test and is test number 3',
    popuptec: ['CSS', 'React', 'Bootstrap', 'Ruby'],
    popupimg: './pictures/oceansandtrails.png',
    btnlive: 'https://oceansandtrails.netlify.app',
    btnsource: 'https://github.com/Flunavgt/oceans_and_trails_frontend',
    btnName: 'btn4',
    btnimg1: './pictures/TimeAndIcons/github.png',
    btnimg2: './pictures/TimeAndIcons/github.png',
  },
